# Getting help with checklist

Thanks for using checklist. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/checklist/issues) to make sure the 
